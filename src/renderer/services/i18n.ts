...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    // 站点
    sitesTitle: '站点',
    sitesSubtitle: '管理部署的服务',
    sitesCreate: '新建站点',
    sitesCreateShort: '新建',
    sitesCreatePrompt: '请帮我创建并部署一个网站。先询问我网站用途和内容需求，完成后提供部署确认。',
  ...
  en: {
    ...
    // Sites
    sitesTitle: 'Sites',
    sitesSubtitle: 'Manage deployed services',
    sitesCreate: 'New site',
    sitesCreateShort: 'New',
    sitesCreatePrompt:
      'Help me create and deploy a website. First ask about its purpose and content, then show a deployment confirmation before publishing.',
    ...
    sitesEmptyDescription:
      'Start with an idea and LobsterAI will help turn it into a deployed website.',
    ...
    sitesTemplateResumePrompt:
      'Help me create a clean, professional resume and portfolio website, and guide me through the information you need.',
    sitesTemplateShop: 'Storefront',
    sitesTemplateShopDescription: 'A page for a small store or studio',
    sitesTemplateShopPrompt:
      'Help me create a storefront with a brand introduction, products or services, business information, and contact details.',
    sitesTemplateEvent: 'Event invitation',
    sitesTemplateEventDescription: 'An online invitation for an event',
    sitesTemplateEventPrompt:
      'Help me create an event invitation site with an introduction, date, location, schedule, and RSVP details.',
    sitesTemplateSurvey: 'Survey',
    sitesTemplateSurveyDescription: 'An online form and response page',
    sitesTemplateSurveyPrompt:
      'Help me create an online survey. First ask about the research goal and the questions I need to collect.',
