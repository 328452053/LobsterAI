...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkBtwResizeWindow: '调整侧边聊天窗口大小',
    coworkBtwEmptyThread: '选中助手文本，或在下方输入问题开始侧聊。',
    coworkBtwInputPlaceholder: '输入侧边问题…',
    coworkBtwSend: '发送侧边问题',
    coworkBtwStop: '停止回答',
    coworkBtwFollowUpHint: 'Enter 发送，Shift+Enter 换行；后续问题会参考此窗口内最近的问答。',
  ...
  en: {
    ...
    coworkBtwResizeWindow: 'Resize side chat window',
    coworkBtwEmptyThread: 'Select assistant text or enter a question below to start a side chat.',
    coworkBtwInputPlaceholder: 'Ask a side question…',
    coworkBtwSend: 'Send side question',
    coworkBtwStop: 'Stop answer',
    coworkBtwFollowUpHint: 'Enter to send, Shift+Enter for a new line. Follow-ups use recent answers in this window.',
